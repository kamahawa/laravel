      ...
      <div class="products-details">
        <div class="preview_image">
          <div class="preview-small">
            <img id="zoom_03" src="{{ URL::asset('public/images/products/medium/products-01.jpg') }}" data-zoom-image="{{ URL::asset('public/images/products/Large/products-01.jpg') }}" alt="">
          </div>
          <div class="thum-image">
            <ul id="gallery_01" class="prev-thum">
              <li>
                <a href="#" data-image="{{ URL::asset('public/images/products/medium/products-01.jpg') }}" data-zoom-image="{{ URL::asset('public/images/products/Large/products-01.jpg') }}">
                  <img src="{{ URL::asset('public/images/products/thum/products-01.png') }}" alt="">
                </a>
              </li>
              <li>
                <a href="#" data-image="{{ URL::asset('public/images/products/medium/products-02.jpg') }}" data-zoom-image="{{ URL::asset('public/images/products/Large/products-02.jpg') }}">
                  <img src="{{ URL::asset('public/images/products/thum/products-02.png') }}" alt="">
                </a>
              </li>
              <li>
                <a href="#" data-image="{{ URL::asset('public/images/products/medium/products-03.jpg') }}" data-zoom-image="{{ URL::asset('public/images/products/Large/products-03.jpg') }}">
                  <img src="{{ URL::asset('public/images/products/thum/products-03.png') }}" alt="">
                </a>
              </li>
              <li>
                <a href="#" data-image="{{ URL::asset('public/images/products/medium/products-04.jpg') }}" data-zoom-image="{{ URL::asset('public/images/products/Large/products-04.jpg') }}">
                  <img src="{{ URL::asset('public/images/products/thum/products-04.png') }}" alt="">
                </a>
              </li>
              <li>
                <a href="#" data-image="{{ URL::asset('public/images/products/medium/products-05.jpg') }}" data-zoom-image="{{ URL::asset('public/images/products/Large/products-05.jpg') }}">
                  <img src="{{ URL::asset('public/images/products/thum/products-05.png') }}" alt="">
                </a>
              </li>
            </ul>
        ...
        <div class="products-description">
          ...
          <p>
            <img alt="" src="{{ URL::asset('public/images/star.png') }}">
          ...
          <hr class="border">
          <img src="{{ URL::asset('public/images/share.png') }}" alt="" class="pull-right">
        </div>
      </div>
      <div class="clearfix">
      </div>
            ...
            <div class="row">
              <div class="col-md-4 col-sm-4">
                <div class="products">
                  ...
                  <div class="thumbnail">
                    <img src="{{ URL::asset('public/images/products/small/products-01.png') }}" alt="Product Name">
                  </div>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="products">
                  <div class="thumbnail">
                    <img src="{{ URL::asset('public/images/products/small/products-02.png') }}" alt="Product Name">
                  </div>
                  <div class="productname">
                    Iphone 5s Gold 32 Gb 2013
                  </div>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="products">
                  ...
                  <div class="thumbnail">
                    <img src="{{ URL::asset('public/images/products/small/products-03.png') }}" alt="Product Name">
                  </div>
                  <div class="productname">
                    Iphone 5s Gold 32 Gb 2013
                  </div>
    ...
    <div class="col-md-3">
      ...
      <div class="fbl-box leftbar">
        ...
        <span class="likebutton">
          <a href="#">
            <img src="{{ URL::asset('public/images/fblike.png') }}" alt="">
          </a>
        </span>
        <p>
        ...
        <div class="fbplug">
          <a href="#">
            <span>
              <img src="{{ URL::asset('public/images/fbicon.png') }}" alt="">
            </span>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ URL::asset('public/js/themeshop/jquery.elevatezoom.js')}}">
    </script>
@stop